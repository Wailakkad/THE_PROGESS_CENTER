                    ...
                    >
                        <div className="mb-12">
                            ...
                            <p className="text-gray-500 font-medium italic mb-2">
                                {t.auth.login.subtitle} <Link to="/register" className="text-blue-600 font-bold hover:underline">{t.auth.login.signup}</Link>
                            </p>
                        </div>
                        ...
                        <button className="w-full flex items-center justify-center gap-4 px-6 py-4 border border-gray-200 rounded-xl font-bold text-gray-700 hover:bg-gray-50 transition-all mb-10 shadow-sm group">
                            ...
                            <span className="text-[13px] font-black uppercase tracking-wider">{t.auth.login.google}</span>
                        </button>
                        ...
                        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div className="flex items-center justify-between pt-2">
                                <label className="flex items-center gap-2 cursor-pointer group">
                                    ...
                                    <span className="text-xs font-bold text-gray-500 uppercase tracking-tight">{t.auth.login.remember}</span>
                                </label>
                                <a href="#" className="text-xs font-black text-blue-600 hover:underline uppercase tracking-tight">
                                    {t.auth.login.forgot}
                                </a>
                            </div>
